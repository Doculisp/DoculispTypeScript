...
import { ICoordinates, IFailCode, ILocation, ISuccess, IUtil, Result } from "../../../src/types/types.general";
...
describe('tokenizer', () => {
    ...
    it('should fail if document parsing failed', () => {
        const parseResult = failCode('This document did not parse', { documentPath: buildPath('X:/non-exist.dlisp'), start: { line: 1, char: 1 }, end: { line: 1, char: 1 } });
