...
**Note:** All examples use standard setup patterns. See [Common Patterns](<!-- (dl (get-path api-common-patterns)) -->) for reusable code blocks including container setup, project location creation, and pipeline processing.
